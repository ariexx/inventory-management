...
@section('page-title')
    <div class="d-flex justify-content-between">
        ...
        <a href="{{ route('admin.restock-requests.index') }}" class="btn btn-secondary">
        ...
        <div class="col-md-4">
            @if($restockRequest->status === 'pending')
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.restock-requests.process', $restockRequest) }}" method="POST">
                            @csrf
            ...
            @if($restockRequest->status === 'approved')
                <div class="card bg-success">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.pesanan-barang.create', [
