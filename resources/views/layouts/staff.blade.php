        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('staff.barang-masuk.index') }}" class="nav-link {{ request()->routeIs('staff.barang-masuk.*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('staff.barang-keluar.index') }}" class="nav-link {{ request()->routeIs('staff.barang-keluar.*') ? 'active' : '' }}">
